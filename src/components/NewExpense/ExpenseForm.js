...
const ExpenseForm = (props) => {
  ...
  //defaultno ponašanje forme i submita je da šalje request i reloada stranicu. Zato koristimo preventDefault(); i submitanje hendlamo sami
  ...
  // nakon submitanja forme resetirali smo inpute, to je moguće zbog dodavanja value atributa na input, i setiranja state-a na prazni string nakon submita
